...
describe('bilingual display strings',()=>{
 it('translates complete labels and preserves names',()=>{expect(translate('Welcome to Leletív','hu')).toBe('Üdvözöljük a Leletívben');expect(translate('Dr. Lilla Tóth','hu')).toBe('Dr. Lilla Tóth');});
