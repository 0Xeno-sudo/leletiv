...
const guidance: Record<string, [string, string]> = {
  ...
  '/advanced': ['Válassz az öt elemzés közül, adj meg bemenetet vagy indíts szintetikus próbát. Ellenőrizd a képeket, javítsd a méréseket, majd mentsd az ellenőrzést és a PDF-jelentést.', 'Choose a workflow, upload inputs or try a synthetic example, review the images and measurements, then save the review and PDF report.'],
  '/compare': ['Nyisd meg a kiinduló és kontrollfelvételt, majd a hozzájuk tartozó területkijelöléseket. Ellenőrizd az anatómiai illesztést a szinkronizálás és változástérkép előtt.', 'Open baseline and follow-up scans and masks. Verify anatomical registration before synchronizing or exporting a difference map.'],
